...
public:
    ...
    virtual unique_ptr<Pokemon> clone() const = 0;
...
class NormalPokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<NormalPokemon>(*this);
    }
};

// Implement the subclasses for the rest of the Pokémon types here
// ---
class FirePokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<FirePokemon>(*this);
    }
};
...
class GrassPokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<GrassPokemon>(*this);
    }
};
...
class WaterPokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<WaterPokemon>(*this);
    }
};
...
class RockPokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<RockPokemon>(*this);
    }
};
...
class ElectricPokemon : public Pokemon {
    ...
    // Overridden clone method that makes a copy of this Pokémon
    unique_ptr<Pokemon> clone() const override {
        return std::make_unique<ElectricPokemon>(*this);
    }
};
